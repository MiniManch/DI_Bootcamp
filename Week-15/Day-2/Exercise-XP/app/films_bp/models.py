...
class Film(db.Model):
	...
	available_in_countries = db.relationship('Country', secondary=film_available_in_table, backref='films_avail_in')
	categories = db.relationship('Category', secondary=categories_for_films, backref='films')
	director = db.relationship('Director', secondary=film_directors, backref='director_films')
